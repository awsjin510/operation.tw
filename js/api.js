...
(function () {
  ...
  window.api = {
    ...
    adminSubscribers: () => call('/api/admin/subscribers', { admin: true }).then((r) => r.subscribers || []),
    adminAddSubscriber: (email) => call('/api/admin/subscribers', { method: 'POST', admin: true, body: { email } }),
    adminDeleteSubscriber: (email) => call('/api/admin/subscribers?email=' + encodeURIComponent(email), { method: 'DELETE', admin: true }),
