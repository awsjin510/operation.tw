...
window.API_BASE = 'https://operation-tw-api.gamania-cloudforce.workers.dev';

// Google 登入用的 OAuth Client ID（Google Cloud Console → 憑證 → OAuth 2.0 用戶端 ID）。
// 後台 admin.html 的「用 Google 登入」按鈕會用到；前台 index.html 不需要。
window.GOOGLE_CLIENT_ID = '802015592462-80erc0326lthbv8rvkqinhn0vfa6u9k4.apps.googleusercontent.com';
