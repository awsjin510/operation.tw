(function(){
  ...
  function article(p,feature){
    ...
    return '<article class="op-article'+(feature?' op-article-feature':'')+'"><a class="op-card-link" href="'+escText(href)+'" aria-label="閱讀：'+escText(p.title)+'"></a><div class="op-article-img"><img src="'+escText(img)+'" alt="'+escText(p.title)+'" loading="lazy" decoding="async" onerror="this.onerror=null;this.src=\'/default.png\'"></div><div class="op-article-body"><div class="op-article-meta"><span class="op-category">'+escText(normalizeCat(p.category))+'</span><span>'+escText(date(p.date))+'</span><span>'+readingTime(p)+' 分鐘</span></div><h3>'+escText(p.title)+'</h3><p>'+escText(strip(p.excerpt))+'</p></div></article>';
  }
  ...
  function build(data){
    ...
    const html='<main class="op-home">'+
      '<section class="op-hero"><div class="op-shell op-hero-grid"><div><div class="op-kicker"><i></i>AI · Cloud · Cyber Security · Podcast</div><h1>把複雜的 <span class="op-gradient-text">AI、雲端與資安</span>，用一篇文章、一集 Podcast 說清楚。</h1><p class="op-hero-copy">提供 AI、Cloud、Cyber Security、企業科技與數位轉型相關觀點，讓你快速理解複雜的科技議題。</p><div class="op-actions"><a class="op-btn op-btn-primary" href="#featured">開始閱讀 <span>\u2192</span></a><a class="op-btn op-btn-secondary" href="/podcast.html">\u25b6 收聽 Podcast</a></div></div><div class="op-hero-visual" aria-label="最新文章"><div class="op-orbit"></div><div class="op-orbit"></div><a class="op-hero-card" href="'+postUrl(hero)+'"><img src="'+escText(hero.image||'/default.png')+'" alt="'+escText(hero.title)+'"><div class="op-hero-card-meta"><span>最新文章</span><span>·</span><span>'+escText(date(hero.date))+'</span></div><h2>'+escText(hero.title)+'</h2><p>'+escText(strip(hero.excerpt))+'</p></a></div></div></section>'+
      '<section class="op-stats"><div class="op-shell op-stats-grid"><div class="op-stat"><strong>'+posts.length+' 篇</strong><span>持續更新的深度文章</span></div><div class="op-stat"><strong>'+eps.length+' 集</strong><span>Podcast 聲音內容</span></div><div class="op-stat"><strong>4 大主題</strong><span>AI / Cloud / Security / 趨勢</span></div><div class="op-stat"><strong>文章 + 聲音</strong><span>適合不同閱讀情境</span></div></div></section>'+
      podcast(eps[0],eps.slice(1))+
      '<section class="op-section" id="featured"><div class="op-shell">'+sectionHead('Editor\'s picks','精選內容','從近期內容中快速進入最值得關注的科技議題。','/ai/','探索所有文章')+'<div class="op-featured-grid">'+article(featured[0],true)+'<div class="op-featured-side">'+featured.slice(1).map(p=>article(p,false)).join('')+'</div></div></div></section>'+
      '<section class="op-section op-section-soft" id="topics"><div class="op-shell">'+sectionHead('Explore','依主題探索','從技術、治理到產業變化，找到此刻最需要的內容。','','')+'<div class="op-categories">'+categoryBlock('AI','模型、工具、Agent 與企業導入觀察。',['AI'],posts,'/category/AI/')+categoryBlock('Cloud','AWS、Azure、GCP 與雲端架構趨勢。',['雲端'],posts,'/category/%E9%9B%B2%E7%AB%AF/')+categoryBlock('Cyber Security','零信任、威脅趨勢與企業防禦策略。',['資安'],posts,'/category/%E8%B3%87%E5%AE%89/')+categoryBlock('科技趨勢','閱讀、工作與數位轉型的延伸觀點。',['閱讀','成長'],posts,'/ai/')+'</div></div></section>'+
      '<section class="op-section" id="about"><div class="op-shell"><div class="op-about"><div class="op-about-media"><img src="/profile.jpg" alt="Jin，操作一下作者" loading="lazy"></div><div><div class="op-eyebrow">About Jin</div><h2 class="op-title">把碎片化資訊，整理成可以開始行動的版本。</h2><p>一位喜歡探索新趨勢、學習新事物的 PM。把網路上分散的資訊加入實際操作經驗與觀點，分享雲端、資安、AI、閱讀與成長。</p><div class="op-tags"><span>Cloud</span><span>AI</span><span>Cyber Security</span><span>Podcast</span></div><div class="op-actions"><a class="op-btn op-btn-primary" href="/about/">閱讀更多</a><a class="op-btn op-btn-secondary" href="mailto:keepfighting510@gmail.com">合作邀約</a></div></div></div></div></section>'+
