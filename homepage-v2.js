(function(){
  ...
  function build(data){
    ...
    const html='<main class="op-home">'+
      ...
      '<section class="op-section" id="featured"><div class="op-shell">'+sectionHead('Editor\'s picks','精選內容','從近期內容中快速進入最值得關注的科技議題。','#topics','依主題探索')+'<div class="op-featured-grid">'+article(featured[0],true)+'<div class="op-featured-side">'+featured.slice(1).map(p=>article(p,false)).join('')+'</div></div></div></section>'+
      '<section class="op-section op-section-soft" id="topics"><div class="op-shell">'+sectionHead('Explore','依主題探索','從技術、治理到產業變化，找到此刻最需要的內容。','','')+'<div class="op-categories">'+categoryBlock('AI','模型、工具、Agent 與企業導入觀察。',['AI'],posts,'/category/AI/')+categoryBlock('Cloud','AWS、Azure、GCP 與雲端架構趨勢。',['雲端'],posts,'/category/%E9%9B%B2%E7%AB%AF/')+categoryBlock('Cyber Security','零信任、威脅趨勢與企業防禦策略。',['資安'],posts,'/category/%E8%B3%87%E5%AE%89/')+categoryBlock('閱讀','書評、閱讀筆記與知識管理。',['閱讀'],posts,'/category/%E9%96%B1%E8%AE%80/')+categoryBlock('成長','學習方法、自媒體經營與職涯思維。',['成長'],posts,'/category/%E6%88%90%E9%95%B7/')+'</div></div></section>'+
      '<section class="op-section" id="about"><div class="op-shell"><div class="op-about"><div class="op-about-media"><img src="/profile.jpg" alt="Jin，操作一下作者" loading="lazy"></div><div><div class="op-eyebrow">About Jin</div><h2 class="op-title">把碎片化資訊，整理成可以開始行動的版本。</h2><p>一位喜歡探索新趨勢、學習新事物的 PM。把網路上分散的資訊加入實際操作經驗與觀點，分享雲端、資安、AI、閱讀與成長。</p><div class="op-tags"><span>Cloud</span><span>AI</span><span>Cyber Security</span><span>Podcast</span></div><div class="op-actions"><a class="op-btn op-btn-primary" href="/faq/">常見問題</a><a class="op-btn op-btn-secondary" href="mailto:keepfighting510@gmail.com">合作邀約</a></div></div></div></div></section>'+
