(function(){
  ...
  function build(data){
    ...
    const html='<main class="op-home">'+
      ...
      // 累積/今日瀏覽：沿用 SPA 既有的 #stat-total / #stat-today id，
      // 由 initDB 的 incrementSiteViews 回填（SPA 是唯一計數來源，不會重複 +1）。
      '<section class="op-stats"><div class="op-shell op-stats-grid"><div class="op-stat"><strong>'+posts.length+' 篇</strong><span>持續更新的深度文章</span></div><div class="op-stat"><strong>'+eps.length+' 集</strong><span>Podcast 聲音內容</span></div><div class="op-stat"><strong id="stat-total">—</strong><span>累積瀏覽</span></div><div class="op-stat"><strong id="stat-today">—</strong><span>今日瀏覽</span></div></div></section>'+
